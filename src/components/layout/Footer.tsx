        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <Link href="/" className="inline-block">
              <h2 className="text-3xl font-extrabold tracking-tighter text-pink-500 text-glow-pink">
            ...
            <p className="text-sm leading-6 text-gray-400 max-w-xs">
              Transformăm viziunile tale în realitate luminoasă. Semne neon premium realizate manual în România.
            </p>
            <div className="flex space-x-6">
              {/* Instagram */}
              <a href="https://www.instagram.com/lightify_ro/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-pink-500 transition-colors">
